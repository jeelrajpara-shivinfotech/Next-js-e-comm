...
export const VisaCard: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg
...
export const Mastercard: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg
    className="icon icon--full-color"
    viewBox="0 0 38 24"
    xmlns="http://www.w3.org/2000/svg"
...
export const AmericanExpress: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg
    className="icon icon--full-color"
    viewBox="0 0 38 24"
    xmlns="http://www.w3.org/2000/svg"
...
export const DinnersClub: React.FC = () => (
  <svg
    className="icon icon--full-color"
    viewBox="0 0 38 24"
    xmlns="http://www.w3.org/2000/svg"
...
export const Discover: React.FC = () => (
  <svg
    className="icon icon--full-color"
    viewBox="0 0 38 24" width="38" height="24" role="img" aria-labelledby="pi-discover"
